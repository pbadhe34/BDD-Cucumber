...
public class REST_JSON_Client {
	...
	public static void main(String[] args) throws IOException {
		...
		URL getUrl = new URL("http://localhost:8080/Angular_CRUD_Module_Project/customers/1");
	   ...
	   System.out.println("*** POST Customer as JSON **");
		...
		URL postUrl = new URL("http://localhost:8080/Angular_CRUD_Module_Project/customers/post");
		...
		// Update customer json object
		   System.out.println("*** Update Customer as JSON **");
			...
			URL updateUrl = new URL("http://localhost:8080/Angular_CRUD_Module_Project/customers/update");
		...
		//	String updateCustomer = "{\"firstName\":\"Vijay\",\"lastName\":\"More\",\"street\":\"MughalStreet\",\"city\":\"Delhi\",\"zip\":\"1222\",\"id\":12,\"state\":\"MP\",\"country\":\"India\"}";
			...
			//System.out.println("The new customer is  " + newCust);
			 ...
			 //we can also use json translator
			  ...
			  obj1.put("firstName", "Kaka");
			  obj1.put("lastName", "Bhosale"); 
			...
			if (conn2.getResponseCode() != HttpURLConnection.HTTP_CREATED) {
				throw new RuntimeException("Failed : HTTP error code : "
						+ conn.getResponseCode());
			}
			...
			// Delete customer json object
			   System.out.println("*** Delete Customer as JSON **");
				...
				URL deleteUrl = new URL("http://localhost:8080/Angular_CRUD_Module_Project/customers/1");
